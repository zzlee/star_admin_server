...
FM.DB = (function(){
    ...
    function constructor(){
        ...
        var mongodb = require('mongodb'),
            ...
            ugcContentGenre = 'miix_it cultural_and_creative mood check_in wls'.split(' '),
                //miix_it: a.k.a.影像合成
            ...
            appGenre = 'ondascreen wowtaipeiarena waterlandsecuries'.split(' '),
      ...
      //DEPRECATED - keep for now for reference
        ...
        var UGCSchema = new Schema({
            ...
            title: {type: String},
            description: {type: String},
            url: { youtube: String, tudou: String, s3: String, s3OfVideoForDooh: String },  //  Youtube, Tudou
