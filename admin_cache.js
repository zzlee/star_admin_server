        ...
        return {
            ...
            getMemberListInfo : function(_limit, _skip, cb){
                ...
                if ( (!_limit) && (!_skip) ) {
                    ...
                    FMDB.listOfdocModels( memberListInfos, {miixMovieVideo_count:{$gte:1}, shine:true},'fb.userName fb.userID _id email mPhone miixMovieVideo_count doohPlay_count movieViewed_count fbLike_count fbComment_count fbShare_count app', {sort:'fb.userName',limit: _limit, skip: _skip}, function(err, result){
