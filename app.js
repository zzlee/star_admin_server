...
//                memberList[anIndex].miixMovieVideo_count = 1+ Math.floor( 4*Math.random()*Math.random()*Math.random()*Math.random() );
//                memberList[anIndex].doohPlay_count = Math.floor( memberList[anIndex].miixMovieVideo_count*2 );
//                memberList[anIndex].fbLike_count = Math.floor( 3+memberList[anIndex].miixMovieVideo_count*37*Math.random() );
//                memberList[anIndex].fbComment_count = Math.floor( memberList[anIndex].fbLike_count*0.5*Math.random() );
//                memberList[anIndex].fbShare_count = Math.floor( memberList[anIndex].fbComment_count*2*Math.random()*Math.random()*Math.random() );
//
